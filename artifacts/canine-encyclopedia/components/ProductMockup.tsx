...
const PRODUCTS = [
  ...
  },
  {
    ...
    label: "Fridge Magnet",
    price: "From £6.99",
    url: "https://onjjem.com/product/photo-magnets",
  },
  {
    id: "canvas",
    label: "Eco Canvas",
    price: "From £16.99",
    url: "https://onjjem.com/product/eco-rolled-canvas",
  },
] as const;
...
// A small square photo tile with a subtle metallic-edge border to suggest
// a fridge magnet.
function MagnetMockup({ photoUri }: { photoUri: string }) {
  return (
    <View style={magnetStyles.wrap}>
      <Image source={{ uri: photoUri }} style={magnetStyles.photo} resizeMode="cover" />
    </View>
  );
}
      ...
      <View style={styles.row}>
        {PRODUCTS.map((product) => (
          ...
          >
            ...
            {product.id === "magnet" && <MagnetMockup photoUri={photoUri} />}
...
const magnetStyles = StyleSheet.create({
  wrap: {
    width: "100%",
    height: 100,
    borderRadius: 8,
