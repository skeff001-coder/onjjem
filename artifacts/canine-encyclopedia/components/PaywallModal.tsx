                ...
                >
                  ...
                  {owned ? (
                    ...
                    <TouchableOpacity
                      ...
                      style={[
                        styles.buyBtn,
                        { backgroundColor: tier.color, opacity: isPurchasing && purchasingKey !== tier.key ? 0.5 : 1 },
                      ]}
                    >
                      {loading ? (
                        <ActivityIndicator color="#0a0e1a" />
                      ) : (
                        <Text style={[styles.buyBtnText, { color: "#0a0e1a" }]}>
        ...
        <View style={[styles.webPromptOverlay, { backgroundColor: "rgba(0,0,0,0.6)" }]}>
          <View style={[styles.webPromptCard, { backgroundColor: colors.card, borderColor: colors.gold + "44" }]}>
            ...
            <Text style={[styles.webPromptBody, { color: colors.mutedForeground }]}>
              Purchases unlock inside the That's My Dog! iOS app.
            </Text>
            <TouchableOpacity
