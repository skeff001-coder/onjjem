...
export const PRODIGI_PRODUCTS: Record<string, ProdigiProduct> = {
  ...
  // £2.99 bundle's free postcard, or the My Dog's Shop native checkout).
  // Never shown to customers as a normal purchasable item on onjjem.com.
  ...
  "wud-magic-mug":        { sku: "magic-mug",                sizing: "fillPrintArea" },
  "wud-bandanna":         { sku: "PET-BANDANA-MED",          sizing: "fillPrintArea" },
  "wud-jigsaw":           { sku: "jigsaw-30",                sizing: "fillPrintArea" },
  "wud-invitation-card":  { sku: "CLASSIC-POST-GLOS-6X4",   sizing: "fillPrintArea" },
};
