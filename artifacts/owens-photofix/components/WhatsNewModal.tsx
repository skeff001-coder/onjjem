...
export const CHANGELOG: Record<string, VersionNotes> = {
  "1.0.50": {
    headline: "What's New in v1.0.50",
    items: [
      {
  ...
  "1.0.49": {
    headline: "What's New in v1.0.49",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.48": {
    headline: "What's New in v1.0.48",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.47": {
    headline: "What's New in v1.0.47",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.46": {
    headline: "What's New in v1.0.46",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.39": {
    headline: "What's New in v1.0.39",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.38": {
    headline: "What's New in v1.0.38",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.37": {
    headline: "What's New in v1.0.37",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.36": {
    headline: "What's New in v1.0.36",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.35": {
    headline: "What's New in v1.0.35",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.30": {
    headline: "What's New in v1.0.30",
    items: [
      {
        icon: "gift-outline",
        accent: "#C9960C",
        title: "Shop Gift Collection",
        body: "Browse and buy personalised photo gifts — canvas prints, mugs, jigsaws, and more — directly from the app.",
      },
      {
        icon: "images-outline",
        accent: "#C9960C",
        title: "Enhanced Photo Gallery",
        body: "New gallery view with improved before/after comparison and easy sharing.",
      },
    ],
  },
  "1.0.29": {
  ...
  "1.0.28": {
    ...
    items: [
      ...
      },
      {
        ...
        accent: "#C9960C",
        title: "Updated Privacy Policy Link",
        body: "Our privacy policy now opens correctly everywhere in the app.",
      },
    ],
  },
  "1.0.27": {
  ...
  "1.0.26": {
    headline: "What's New in v1.0.26",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.25": {
    headline: "What's New in v1.0.25",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.24": {
    headline: "What's New in v1.0.24",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.23": {
    headline: "What's New in v1.0.23",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.21": {
    headline: "What's New in v1.0.21",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.20": {
    headline: "What's New in v1.0.20",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.19": {
    headline: "What's New in v1.0.19",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.18": {
    headline: "What's New in v1.0.18",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.17": {
    headline: "What's New in v1.0.17",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.16": {
    headline: "What's New in v1.0.16",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
  ...
  "1.0.15": {
    headline: "What's New in v1.0.15",
    items: [
      {
        icon: "sparkles-outline",
        accent: "#C9960C",
