...
export default function CartoonScreen() {
  ...
  const pickPhoto = async () => {
    ...
    if (!permission.granted) {
      setErrorMsg("We need permission to access your photos to continue.");
      setPhase("error");
      return;
    }
    ...
    setPhase("picked");
    generateCartoon(asset.base64 ?? "", asset.mimeType ?? "image/jpeg");
  };
    ...
    <View style={s.root}>
      ...
      >
        ...
        <View style={s.hero}>
          ...
          <Text style={s.subtitle}>Turn any photo into a vibrant, animated-movie-style illustration</Text>
          <View style={s.goldLine} />
        </View>
