...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    label: "Home & Décor",
    emoji: "🏡",
    subtitle: "Vases · Plant pots · Candles · Footstools · Side tables · Folding screens — your photo in every corner of the home",
    fulfillment: "ONJJEM Master Print Lab · UK Master Printers",
  ...
  },
  {
    ...
    emoji: "👒",
    subtitle: "Baseball caps · Belts · Sarongs · Bandanas · Hair accessories · Sunglasses · Keyrings — wear your memories",
    fulfillment: "ONJJEM Master Print Lab · UK Master Printers",
...
const MENU_TABS = ["anniversaries", "living", "prints", "wall_art", "keepsakes", "kitchen_dining", "home_decor", "fashion_accessories", "jewellery", "heritage_jigsaws", "bargain_memories", "large_format"];
