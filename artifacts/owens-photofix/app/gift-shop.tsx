...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    label: "Keepsakes",
    emoji: "🎁",
    subtitle: "Mugs · Cufflinks · Acrylic blocks · Coasters · Silk ties · Hip flasks · Baubles — all from your restored photo",
...
const MENU_TABS = ["anniversaries", "living", "prints", "wall_art", "keepsakes", "heritage_jigsaws", "bargain_memories", "large_format"];
