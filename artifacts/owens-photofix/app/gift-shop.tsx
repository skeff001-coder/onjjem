...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    label: "Wall Art",
    emoji: "🖼️",
    subtitle: "Tapestry · Split canvas · Aluminium · Framed prints · Wall hangings — all from your restored photo",
    fulfillment: "ONJJEM Master Print Lab · UK Master Printers",
    ...
    products: [
      {
        ...
        size: "100×130 cm · 130×180 cm · or 150×200 cm · woven fabric · rod & cord included",
        desc: "Your restored family portrait woven into a magnificent fabric tapestry — one of the most striking and unusual gifts you can give. Printed on heavy woven fabric with the look and feel of a true woven textile, supplied complete with a hanging rod and cord, ready to display the moment it arrives. Rich, warm colours that glow on the wall. A genuine heirloom — nothing else like it exists. 10-year print guarantee.",
        price: "£89.99",
        emoji: "🏺",
        iconBg: "#3D2B1F",
        wide: true,
      ...
      },
      {
        ...
        desc: "Your restored photo printed directly onto brushed aluminium — a sleek, contemporary finish that gives restored photographs an almost three-dimensional luminosity. Completely frameless, arrives ready to hang with a float mount system. Scratch and moisture resistant. The most modern way to display a heritage photo. 10-year print guarantee.",
        price: "£49.99",
        emoji: "⚡",
        iconBg: "#1E2A3A",
        wide: true,
...
const MENU_TABS = ["anniversaries", "living", "prints", "wall_art", "heritage_jigsaws", "bargain_memories", "large_format"];
