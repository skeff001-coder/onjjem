...
const CATEGORIES: Category[] = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        emoji: "✨",
        iconBg: "#FDF6DC",
        photo: require("@/assets/images/cushion_silk.jpg"),
        wide: true,
        premiumBadge: true,
        onjjemSeal: true,
      ...
      },
      {
        ...
        size: "100×75cm · Plush Velvet · Rich Wine",
        desc: "Plush Velvet front with your expertly restored photo, hand-finished in London. Rich wine-red colourway — vibrant, permanent print, perfect draped over the back of your sofa.",
        price: "£69.99",
        emoji: "🛋️",
        iconBg: "#F0F7F0",
        photo: require("@/assets/images/throw_burgundy.jpg"),
        wide: true,
        handmadeInLondon: true,
      ...
      },
      {
        id: "throw_medium",
        title: "Luxury Photo Throw Blanket",
        size: "145×106cm · Plush Velvet · Midnight Navy",
        desc: "Our most popular size — drapes beautifully over sofas and armchairs. Deep midnight-navy colourway with a vibrant, permanent photographic print, hand-finished in London.",
        price: "£84.99",
        emoji: "🛋️",
        iconBg: "#EBF5EB",
        photo: require("@/assets/images/throw_navy.jpg"),
        wide: true,
        bestSeller: true,
        handmadeInLondon: true,
        freePersonalisation: true,
      },
      {
        id: "throw_large",
        title: "Luxury Photo Throw Blanket",
        size: "198×145cm · Plush Velvet · Sage Green",
        desc: "The ultimate statement piece. Generous king-size dimensions in a calming sage-green colourway. Plush Velvet front, hand-finished by our London artisans.",
        price: "£94.99",
        emoji: "🛋️",
        iconBg: "#E6F0E6",
        photo: require("@/assets/images/throw_green.jpg"),
        wide: true,
        premiumBadge: true,
        handmadeInLondon: true,
        freePersonalisation: true,
      },
      {
        ...
        desc: "Our most luxurious throw. Plush Velvet front with a sumptuously soft Sherpa fleece reverse — six colour choices. Hand-finished in London. Worth every penny.",
        price: "£94.99",
        emoji: "✨",
        iconBg: "#FDF6DC",
        photo: require("@/assets/images/throw_sherpa.jpg"),
        wide: true,
        bestSeller: true,
        premiumBadge: true,
        onjjemSeal: true,
