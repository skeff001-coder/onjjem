...
const TILES = [
  { name: "Christmas", icon: "snow-outline" },
...
const REVIEWS = [
  ...
  { name: "James T, Manchester", product: "Magic Photo Mug", text: "Ordered a magic mug with my sons favourite footballer on it. Christmas morning was unbelievable - he could not believe it!" },
    ...
    <View style={s.root}>
      ...
      >
        ...
        <View style={s.xmasBanner}>
          ...
          <View style={s.xmasRow}>
            <Ionicons name="snow-outline" size={16} color="#F5D78E" />
            <Text style={s.xmasItem}>Buy 3 Christmas Baubles and get a 4th FREE</Text>
          </View>
        </View>

        <View style={s.mugFeature}>
          <Text style={s.mugLabel}>CHRISTMAS BESTSELLER</Text>
          <Text style={s.mugTitle}>The Magic Photo Mug</Text>
          <Text style={s.mugDesc}>
            Starts solid black. Pour in a hot drink and your photo rises up in full colour
            - your favourite sports star, pop singer, or family photo revealed like magic.
            The gift they will talk about all Christmas Day.
          </Text>
        ...
        <View style={s.deliveryBox}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={s.deliverySub}>
              ...
              working days. Order before 20th December for guaranteed Christmas delivery.
            </Text>
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  mugFeature: { backgroundColor: "#0F0A04", borderWidth: 1, borderColor: "rgba(201,150,12,0.35)", borderRadius: 12, padding: 14, gap: 8 },
  mugLabel: { fontSize: 9, color: GOLD, letterSpacing: 2.5, fontWeight: "700" },
  mugTitle: { fontSize: 16, color: "#FFF5E0", fontWeight: "800" },
  mugDesc: { fontSize: 12, color: "rgba(245,237,216,0.75)", lineHeight: 19 },
  mugBtn: { backgroundColor: GOLD, borderRadius: 8, paddingVertical: 10, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, marginTop: 2 },
  mugBtnText: { fontSize: 13, fontWeight: "700", color: DARK },
  ...
  footerLink: { alignItems: "center", paddingVertical: 8, backgroundColor: "rgba(255,255,255,0.02)", borderRadius: 8, borderWidth: 1, borderColor: "rgba(201,150,12,0.08)" },
  footerLinkText: { fontSize: 12, color: "rgba(245,215,142,0.4)" },
});
