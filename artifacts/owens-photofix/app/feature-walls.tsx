...
const PAPER_TYPES = [
  {
    id: "standard",
    name: "Standard 120gsm",
    spec: "Paste-the-wall · matte textured finish · Greenguard Gold certified",
    retailPerSqm: 59,
    badge: "MOST POPULAR" as const,
    badgeColor: "#34D399",
    desc: "120gsm matte textured wallpaper — our most popular choice. Apply paste directly to the wall, then hang. Clean, contemporary finish that suits any room. Greenguard Gold-certified eco-friendly, solvent-free inks. Long-lasting, non-fade result.",
  },
  {
    id: "premium",
    name: "Premium 173gsm",
    spec: "Spray the wall · lightly textured · 10-yr non-fade guarantee",
    retailPerSqm: 75,
    badge: "HERITAGE CHOICE" as const,
    badgeColor: GOLD,
    desc: "173gsm lightly textured paper — heavier and more refined than Standard. Simply spray the wall with water, then slide the panel into place. Scratch and abrasion resistant. The preferred choice for heritage and portrait murals. 10-year non-fade guarantee. Greenguard Gold-certified inks.",
  },
  {
    id: "royalgold",
    name: "Royal Gold 173gsm",
    spec: "Paste-the-wall · subtle metallic shimmer · warm golden tones",
    retailPerSqm: 82,
    badge: "LUXURY FINISH" as const,
    badgeColor: "#D4AF37",
    desc: "173gsm paste-the-wall paper with a beautiful subtle metallic shimmer. The gold-kissed finish brings extraordinary warmth to restored heritage portraits — skin tones glow, period details shine. A statement choice for dining rooms, hallways and grand entrances. Greenguard Gold-certified inks.",
  },
  {
    id: "grasscloth",
    name: "Faux Grasscloth 275gsm",
    spec: "Paste-the-wall · natural woven texture · organic warmth",
    retailPerSqm: 85,
    badge: "NATURAL TEXTURE" as const,
    badgeColor: "#8BC34A",
    desc: "275gsm paste-the-wall paper with a beautiful faux woven texture that mimics natural grasscloth. The organic surface gives restored family photographs a warmth and depth no smooth paper can match — perfect for heritage, countryside and period images. A genuinely distinctive finish.",
  },
  {
    id: "selfadhesive",
    name: "Self-Adhesive 350gsm",
    spec: "Peel-and-stick · fully repositionable · no paste or water needed",
    retailPerSqm: 89,
    badge: "PEEL & STICK" as const,
    badgeColor: "#93C5FD",
    desc: "350gsm peel-and-stick — no paste, no water, no mess. Peel the backing, press to the wall and reposition as many times as you need. Perfect for renters, feature alcoves and temporary installations. The heavyweight 350gsm backing gives it a premium feel on the wall. 10-year non-fade guarantee.",
  },
  {
    id: "silkvista",
    name: "Silk Vista 350gsm",
    spec: "Paste-the-wall · silk-smooth luxury surface · finest quality",
    retailPerSqm: 95,
    badge: "FINEST QUALITY" as const,
    badgeColor: "#C084FC",
    desc: "Our most luxurious paper — 350gsm paste-the-wall with a breathtakingly smooth silk-finish surface. Photographs printed on Silk Vista have an almost photographic depth and clarity that other papers simply cannot achieve. The heavyweight weight hangs perfectly flat with no ripple. The choice for master bedrooms, formal dining rooms and statement installations. 10-year non-fade guarantee.",
  },
] as const;
